...
Feature: YS tests
  ...
  Scenario: YS scenario 1
    ...
    And YS retrieve activation info for email "ouruser@email.com"
  ...
  Scenario:  YS scenario 6
    ...
    And I wait for 2 sec
    And YS click on "StudentAnswer1"
    And I wait for 2 sec
    And YS click on "StudentAnswer2"
    And I wait for 2 sec
    And YS click on "Submit My Answers"
    And element with xpath "//*[contains(text(),'Success!')]" should  be displayed